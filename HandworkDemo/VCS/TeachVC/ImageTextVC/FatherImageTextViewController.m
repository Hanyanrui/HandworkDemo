//
//  FatherImageTextViewController.m
//  HandworkDemo
//
...
@interface FatherImageTextViewController ()<DOPDropDownMenuDelegate,DOPDropDownMenuDataSource>
...
@implementation FatherImageTextViewController
...
{
    DOPDropDownMenu *menu = [[DOPDropDownMenu alloc] initWithOrigin:CGPointMake(0, 0) andHeight:35];
    menu.delegate = self;
